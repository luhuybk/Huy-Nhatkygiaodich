...
function emptyCapitalFlow(date) {
...
function buildCapitalIndexCurve(entries, flows) {
...
function CapitalTrackerPage({ accounts, entries, flows, onAccountsChange, onEntriesChange, onFlowsChange }) {
